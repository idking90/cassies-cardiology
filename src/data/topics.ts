...
export const topics: Topic[] = [
  {
    ...
    choices: ['Rate and regularity', 'P-wave morphology', 'QRS duration', 'ST-segment contour'],
  ...
  },
  {
    ...
    choices: ['Timing', 'Radiation', 'Location', 'Response to a maneuver'],
  ...
  },
  {
    ...
    choices: ['Symptom timeline', 'Risk factors', 'Initial testing', 'Disposition planning'],
  ...
  },
  {
    ...
    choices: ['Symptoms', 'Volume status', 'Medication history', 'Follow-up plan'],
