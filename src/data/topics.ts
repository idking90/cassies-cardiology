...
export const topics: Topic[] = [
  {
    ...
    choices: ['Rate and regularity', 'P-wave morphology', 'QRS duration', 'ST-segment contour'], responseCounts: [11, 6, 3, 4],
  ...
  },
  {
    ...
    choices: ['Timing', 'Radiation', 'Location', 'Response to a maneuver'], responseCounts: [4, 12, 7, 2],
  ...
  },
  {
    ...
    choices: ['Symptom timeline', 'Risk factors', 'Initial testing', 'Disposition planning'], responseCounts: [8, 5, 9, 3],
  ...
  },
  {
    ...
    choices: ['Symptoms', 'Volume status', 'Medication history', 'Follow-up plan'], responseCounts: [6, 10, 4, 6],
